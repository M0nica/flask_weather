...
* Submit an [issue ticket](https://github.com/M0nica/flask_weather/issues)
...
* Lint Python code using the `flake8` tool
    * Run the `flake8` command in the base directory and fix any problems reported.
